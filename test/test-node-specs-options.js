...
module.exports = exports = function() {
  return {
    ...
    specs: ['test/base-spec.js'/*, 'test/nestedmap-spec.js'*/, 'test/domain-spec.js', 'test/module-spec.js', 'test/state-spec.js', 'test/transition-spec.js', 'test/view-spec.js', 'test/app-spec.js', 'test/ampere-spec.js'],
